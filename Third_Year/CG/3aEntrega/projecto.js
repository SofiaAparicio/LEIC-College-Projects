var camera,cameraOrto,cameraPerspStatic,cameraPerspShip, directionalLight, renderer, scene,nave;
var heightPlan= 900;
var widthPlan = 1300;
var viewSize = 1000;
var alienSpeed = 100;
	...
	switch (tecla.keyCode){
		...
		case 110: //n
			if (directionalLight.intensity != 0)
				directionalLight.intesity == 0;
			else directionalLight.intensity = directionalLightIntensity;
			break;
		case 32:
			if(visible){
				visible = false;
